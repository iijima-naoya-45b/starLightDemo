...
**ポケモンで例えると**: Javaを理解することは、新しい「わざ」を覚えるようなもの——使いこなせば、より強力な開発者になれます。
...
`? extends T`で、Tまたはそのサブ種類を受け入れます。

```java
// Numberまたはそのサブ種類のリストを受け入れる
...
`? super T`で、Tまたはそのスーパー種類を受け入れます。

```java
// Integerまたはそのスーパー種類のリストを受け入れる
