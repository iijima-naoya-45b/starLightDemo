...
**ポケモンでいえば**: シングルかダブルか、伝説禁止か——**ルールを知らずにチームは組めない**。
...
**ポケモンでいえば**: 既存の強要素を使わず、マイナー要素で無理やり取り組む。
...
**ポケモンでいえば**: ガブリアス、ボーマンダ——**昔から強い定番要素**を使う。
